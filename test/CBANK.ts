...
const TOKEN_NAME: string = "CRYPTO BANK";
const TOKEN_SYMBOL: string = "CBANK";
const TOTAL_SUPPLY: string = "10000000000000000000000000000";

describe(TOKEN_SYMBOL + " Token Test", function () {
    let contract: CBANK;
    let supervisorContract: CBANK;
    let ordinaryContract: CBANK;
    let freezedContract: CBANK;
    let burnerContract: CBANK;
    let lockerContract: CBANK;
    let timeLocked1Contract: CBANK;
    let timeLocked2Contract: CBANK;
    let timeLocked3Contract: CBANK;
    let vestingLocked1Contract: CBANK;
    let vestingLocked2Contract: CBANK;
    let owner: string;
    ...
    beforeEach(async function () {
        ...
        contract = (await Contract.deploy()) as CBANK;
